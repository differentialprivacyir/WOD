...
def Duchi_randomize(t: float, epsilon: float) -> float:
    """
    ...
    rng : numpy.random.Generator, optional
        Source of randomness; if None, uses default BitGenerator.
...
def Duchi_multidim_ldp(x: Sequence[float], eps: float, rng=np.random.default_rng()):
    """
